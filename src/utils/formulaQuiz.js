...
const RANGES = [
  ...
  [/sitzungen/, [2000, 40000]],
  [/besucher/, [2000, 40000]],
  [/absprünge/, [200, 8000]],
  [/klicks/, [200, 4000]],
  // Statistik: k darf n nicht überschreiten, deshalb deutlich kleiner.
  [/versuche/, [8, 30]],
  [/treffer k/, [1, 6]],
  [/mögliche/, [10, 60]],
  [/günstige/, [1, 8]],
  [/trefferwahrsch|wahrscheinlichkeit/, [5, 60]],
  [/mittelwert|standardabw|wert x/, [20, 120]],
  // Bilanzpositionen in glaubwürdiger Grössenordnung zueinander
  [/anlagevermögen/, [100000, 600000]],
  [/zahlungsmittel/, [10000, 80000]],
  [/jahresüberschuss/, [10000, 80000]],
  [/abschreibung|afa pro jahr/, [5000, 50000]],
  [/rückstellung/, [1000, 20000]],
  [/wiederkäufer/, [50, 800]],
  [/kunden gesamt/, [800, 6000]],
  [/erfüllte aufträge/, [200, 2000]],
  [/aufträge gesamt/, [800, 4000]],
  [/zahlungsziel/, [20, 60]],
  [/skontofrist/, [5, 14]],
  [/periodenleistung/, [500, 5000]],
  [/gesamtleistung/, [20000, 200000]],
  [/menge hoch/, [800, 2000]],
  [/menge tief/, [100, 600]],
  [/kosten hoch/, [40000, 90000]],
  [/kosten tief/, [10000, 30000]],
  ...
  [/anschaffung|kapital|darlehen|umsatz|kosten|ertrag|erträg|aufwand|aufwendung|steuer|brutto|grundwert|umlaufverm|vermögen|schulden|wareneinsatz|verbindlichk|bestand/, [50000, 400000]],
];
